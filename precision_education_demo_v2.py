...
# Enhanced prompt generation logic with role-based customization
...
role = st.radio(
    "Select your role",
    ["Medical Student", "Resident", "Fellow", "APP", "Attending", "RN", "RT"]
)
